"""
SIRAH Tools GUI Main Application

This module serves as the main entry point for the SIRAH Tools GUI application.
It initializes the main Tkinter/ttkbootstrap window, configures the graphical style,
manages theme switching between dark and light modes, and builds the tab-based
interface for the different analysis workflows available in the program.

The application integrates multiple modules for file loading, general analysis,
contact analysis, secondary structure analysis, backmapping, and help/about information,
providing a unified graphical environment for the analysis of SIRAH simulation data.

Features:
    - Initialize the main SIRAH Tools GUI window.
    - Configure responsive window dimensions based on screen size.
    - Apply and update global font styling.
    - Toggle between dark and light visual themes.
    - Create and manage all main application tabs.
    - Maintain a shared analysis state across modules.
    - Reset analysis tabs dynamically when new files are loaded.
...
Dependencies:
    ...
    - tkinter
    - ttkbootstrap
    - modules.load_files_tab
    - modules.analysis_tab
    - modules.contacts_tab
    - modules.ss_analysis_tab
    - modules.backmapping_tab
    - modules.about_tab

Usage:
    Run this module directly to launch the SIRAH Tools GUI application:
