...
This module provides the informational "About" tab for the SIRAH Tools GUI.
It displays general information about the software, including a description
of the tool, documentation links, project website, and licensing details.

The module creates a scrollable interface containing formatted text,
interactive hyperlinks, and the official SIRAH logo image with automatic
resizing support.

Features:
    - Display a general description of the SIRAH Tools GUI.
    - Provide direct hyperlinks to:
        • SIRAH official website
        • SIRAH documentation
        • SIRAH Tools tutorials
        • GNU General Public License
    - Render text content in a scrollable interface.
    - Highlight hyperlinks and allow them to open in the system web browser.
    - Display the SIRAH project logo with dynamic resizing to fit the window.
    - Support high-DPI scaling for improved readability on modern displays.
...
Usage:
    This module is integrated into the SIRAH Tools GUI and provides
    information about the software, documentation resources, and licensing.

    The function `create_about_tab()` initializes the AboutTab class
    and builds the content displayed in the "About" tab.
