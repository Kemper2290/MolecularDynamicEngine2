...
#----------------------------------------------------------------------#
# ORIGINAL VERSION BY: Matias Machado  E-MAIL: mmachado@pasteur.edu.uy #
# CURRENT  VERSION BY: Lucianna Silva  E-MAIL: lsilva@pasteur.edu.uy   #
# VERSION:   2.4.0, Mar 2026                                           #
#                                                                      #
...
Examples:
  ...
  2.        Backmap current frame of molecule 3, including lipids and extending minimization steps to improve convergency
            sirah_backmap now mol 3 lipid maxcyc 250 ncyc 200

  3.        Backmap current frame of top molecule, including non-standard amber topologies with a user defined path
...
Description:
  ...
  sirah_backbone   Protein and DNA backbone atoms
...
proc sirah_ss_ramach {phi psi} {
   # Classify secondary structure elements using a "STRIDE" criteria
...
proc sirah_mapdb {} {
   ...
   # Amino-Acids
     ...
     #DIHYDROXYPHENYLALANINE --- ADDED to AA Petite SIRAH
     dict set backmap                                            \
         sYo  { name  DAH                                        \
               build {N   {: GN } CA {: GC} O {: GO} N+ {: GN/+} \
                      CG  {: BCG} CE1 {: BOE1} CE2 {: BOZ}       \
                                                                 \
                      C   {+ {O   CA  N+  } {1.24  32.0    0.0}} \
                      CB  {+ {CA  N   C   } {1.50 109.0 -120.0}} \
                      CD1 {+ {CG  CE2 CE1 } {1.40  90.0    0.0}} \
     ...
     #METHIONINE SULFOXIDE --- ADDED to AA Petite SIRAH
     dict set backmap                                            \
         sMo  { name  SME                                        \
               build {N   {: GN } CA {: GC} O {: GO} N+ {: GN/+} \
                      S  {: BSD}  OE  {: BOE}                    \
                      ...
                      C   {+ {O   CA  N+  } {1.24  32.0    0.0}} \
                      CB  {+ {CA  N   C   } {1.50 109.0 -120.0}} \
                      CG  {+ {S  CB  CA   } {1.80  32.0 -130.0}} \
                      CE  {+ {S  CG  CB   } {1.80 109.0   60.0}} \
                     }                                           \
               last  {build {N+  {: GN}}}                        \
               print {N CA C O CB CG S  CE OE}                   \
             }
   ...
   ## Membrane
   ## There is a step that runs in the backmap proc that opens the PDB file and corrects 
   ## residues names of the lipid atoms using a regsub command.
     dict set backmap                                                          \
         CMM { name PC                                                         \
               build {N31 {: BCO} P31 {: BFO} C2 {: BGL}                       \
                      C11 {: BE1} C21 {: BE2} C14MYA {: BC11}                  \
                      C17MYA {: BC12} C110MYA {: BC13}                         \
                      C113MYA {: BCT1} C14MYB {: BC21}                         \
                      C17MYB {: BC22} C110MYB {: BC23}                         \
                      C113MYB {: BCT2}                                         \
                                                                               \
                      C31 {+ {N31 P31  C2} {2.65   35.0   100.0}}              \
                      C32 {+ {C31 N31 P31} {1.50   30.0  -130.0}}              \
                      O32 {+ {C31 P31 C32} {1.43   30.0    25.0}}              \
                      O31 {+ {P31 O32 C31} {1.61  100.0  -165.0}}              \
                      O34 {+ {P31 O32 O31} {1.61  110.0  -115.0}}              \
                      O33 {+ {P31 O32 O31} {1.61  113.0   110.0}}              \
                       C3 {+ {C2  O31 P31} {1.50   35.0   135.0}}              \
                      O21 {+ {C21 C2   C3} {1.43   36.0   -45.0}}              \
                       C1 {+ {C2  C3  O21} {1.50  115.0  -120.0}}              \
                      O11 {+ {C1  C2   C3} {1.43  116.0    90.0}}              \
                   C12MYA {+ {C11 O11  C1} {1.50  105.0   170.0}}              \
                   C13MYA {+ {C12MYA  C11      O11   } {1.50  105.0 -120.0}}   \
                   C15MYA {+ {C14MYA  C13MYA   C12MYA} {1.50  115.0  -85.0}}   \
                   C16MYA {+ {C17MYA  C15MYA   C14MYA} {1.50   35.0   20.0}}   \
                   C18MYA {+ {C17MYA  C16MYA   C15MYA} {1.50  117.0   60.0}}   \
                   C19MYA {+ {C110MYA C18MYA   C17MYA} {1.50   30.0 -135.0}}   \
                  C111MYA {+ {C110MYA C19MYA   C18MYA} {1.50  115.0   67.0}}   \
                  C112MYA {+ {C113MYA C111MYA C110MYA} {1.50   35.0  -80.0}}   \
                  C114MYA {+ {C113MYA C112MYA C111MYA} {1.50  109.0  177.0}}   \
                   C12MYB {+ {C21 O21  C2} {1.50  105.0    -170.0}}            \
                   C13MYB {+ {C12MYB  C21      O21   } {1.50  115.0  -75.0}}   \
                   C15MYB {+ {C14MYB  C13MYB   C12MYB} {1.50  110.0  145.0}}   \
                   C16MYB {+ {C17MYB  C15MYB   C14MYB} {1.50   35.0 -140.0}}   \
                   C18MYB {+ {C17MYB  C16MYB   C15MYB} {1.50  115.0  160.0}}   \
                   C19MYB {+ {C110MYB C18MYB   C17MYB} {1.50   35.0  -30.0}}   \
                  C111MYB {+ {C110MYB C19MYB   C18MYB} {1.50  115.0   80.0}}   \
                  C112MYB {+ {C113MYB C111MYB C110MYB} {1.50   35.0   15.0}}   \
                  C114MYB {+ {C113MYB C112MYB C111MYB} {1.50  113.0 -175.0}}   \
                  }                                                            \

               print {C12MYA C13MYA C14MYA C15MYA C16MYA C17MYA C18MYA C19MYA  \
                      C110MYA C111MYA C112MYA C113MYA C114MYA                  \
                      N31 P31 C2 C31 C32 O32 O31 O34 O33 C3 O21 C11 C21 C1 O11 \
                      C12MYB C13MYB C14MYB C15MYB C16MYB C17MYB C18MYB C19MYB  \
                      C110MYB C111MYB C112MYB C113MYB C114MYB}                 \
             }

     dict set backmap                                                          \
         CPO { name  PC                                                        \
               build {N31 {: BCO} P31 {: BFO}                                  \
                      ...
                      C118OL {: BCT2}                                          \
                                                                               \
                      C31 {+ {N31 P31  C2} {2.65   30.0   120.0}}              \
                      C32 {+ {C31 N31 P31} {1.50   35.0  -115.0}}              \
                      O32 {+ {C31 P31 C32} {1.43   30.0   -65.0}}              \
                      O31 {+ {P31 O32 C31} {1.61  109.0    97.0}}              \
                      O34 {+ {P31 O32 O31} {1.61  109.0  -115.0}}              \
                      O33 {+ {P31 O32 O31} {1.61  112.0   115.0}}              \
                      C3  {+ {C2  O31 P31} {1.50   35.0    25.0}}              \
                      O21 {+ {C21 C2   C3} {1.43   35.0  -100.0}}              \
                       C1 {+ {C2  C3  O21} {1.50  105.0  -117.0}}              \
                      O11 {+ {C1  C2   C3} {1.43  115.0   170.0}}              \
                    C12OL {+ {C21 O21  C2} {1.50  117.0  -175.0}}              \
                    C13OL {+ {C12OL   C21      O21  } {1.50  105.0  109.0}}    \
                    C15OL {+ {C14OL   C13OL    C12OL} {1.50  120.0   65.0}}    \
                    C16OL {+ {C15OL   C14OL    C13OL} {1.50  109.0   60.0}}    \
                    C18OL {+ {C17OL   C16OL    C15OL} {1.50  121.0   60.0}}    \
                    C19OL {+ {C18OL   C17OL    C16OL} {1.50  115.0   60.0}}    \
                   C111OL {+ {C110OL  C19OL    C18OL} {1.50  132.0    3.0}}    \
                   C112OL {+ {C111OL  C110OL   C19OL} {1.50  115.0 -130.0}}    \
                   C114OL {+ {C113OL  C112OL  C111OL} {1.50  110.0 -177.0}}    \
                   C115OL {+ {C114OL  C113OL  C112OL} {1.50  112.0  177.0}}    \
                   C117OL {+ {C116OL  C115OL  C114OL} {1.50  115.0  -35.0}}    \
                    C12PA {+ {C11   O11  C1} {1.50  110.0  170.0}}             \
                    C13PA {+ {C14PA   C12PA    C11  } {1.50   32.0   20.0}}    \
                    C15PA {+ {C14PA   C13PA    C12PA} {1.50  120.0  180.0}}    \
                    C16PA {+ {C15PA   C14PA    C13PA} {1.50  116.0  177.0}}    \
                    C18PA {+ {C17PA   C16PA    C15PA} {1.50  116.0 -165.0}}    \
                    C19PA {+ {C18PA   C17PA    C16PA} {1.50  115.0  -65.0}}    \
                   C111PA {+ {C110PA  C19PA    C18PA} {1.50  115.0 -175.0}}    \
                   C112PA {+ {C111PA C110PA    C19PA} {1.50  115.0   70.0}}    \
                   C114PA {+ {C113PA C112PA   C111PA} {1.50  120.0  160.0}}    \
                   C115PA {+ {C116PA C114PA   C113PA} {1.50   35.0    7.0}}    \
                     }                                                         \

               print {C12PA C13PA C14PA C15PA C16PA C17PA C18PA C19PA C110PA   \
                      C111PA C112PA C113PA C114PA C115PA C116PA                \
                      N31 P31 C2 C31 C32 O31 O34 O33 C3 O21 C11 C21 C1 O11     \
                      C12OL C13OL C14OL C15OL C16OL C17OL C18OL C19OL C110OL   \
                      C111OL C112OL C113OL C114OL C115OL C116OL C117OL C118OL} \
             }
         ...
         EPO { name PE                                                         \
               build {N31 {: BPE} P31 {: BFO} C2 {: BGL}                       \
                      ...
                      C116OL {: BC25} C118OL {: BCT2}                          \
                                                                               \
                      C31 {+ {N31 P31  C2} {2.65   40.0    90.0}}              \
                      C32 {+ {C31 N31 P31} {1.50   35.0  -115.0}}              \
                      O32 {+ {C31 P31 C32} {1.43   30.0   -95.0}}              \
                      O31 {+ {P31 O32 C31} {1.61  109.0    -5.0}}              \
                       C3 {+ {C2  O31 P31} {1.50   35.0   120.0}}              \
                      O21 {+ {C21 C2   C3} {1.43   35.0  -115.0}}              \
                       C1 {+ {C2  C3  O21} {1.50  111.0  -121.0}}              \
                      O11 {+ {C1  C2   C3} {1.43  115.0  -161.0}}              \
                    C12OL {+ {C21 O21  C2} {1.50  106.0   175.0}}              \
                    C13OL {+ {C12OL   C21      O21  } {1.50  120.0  -35.0}}    \
                    C15OL {+ {C14OL   C13OL    C12OL} {1.50  120.0   65.0}}    \
                    C16OL {+ {C15OL   C14OL    C13OL} {1.50  105.0   80.0}}    \
                    C18OL {+ {C17OL   C16OL    C15OL} {1.50  115.0 -170.0}}    \
                    C19OL {+ {C18OL   C17OL    C16OL} {1.50  112.0  -72.0}}    \
                   C111OL {+ {C110OL  C19OL    C18OL} {1.50  132.0   -2.0}}    \
                   C112OL {+ {C111OL  C110OL   C19OL} {1.50  110.0  115.0}}    \
                   C114OL {+ {C113OL  C112OL  C111OL} {1.50  120.0  -80.0}}    \
                   C115OL {+ {C116OL  C114OL  C113OL} {1.50   30.0  135.0}}    \
                   C117OL {+ {C116OL  C115OL  C114OL} {1.50  115.0 -135.0}}    \
                    C12PA {+ {C11   O11 C1 } {1.50  109.0  -160.0}}            \
                    C13PA {+ {C12PA C11 O11} {1.50  112.0   170.0}}            \
                    C15PA {+ {C14PA   C13PA   C12PA } {1.50  120.0   60.0}}    \
                    C16PA {+ {C15PA   C14PA   C13PA } {1.50  116.0  175.0}}    \
                    C18PA {+ {C17PA   C16PA   C15PA } {1.50  115.0 -180.0}}    \
                    C19PA {+ {C18PA   C17PA   C16PA } {1.50  111.0  -45.0}}    \
                   C111PA {+ {C110PA  C19PA   C18PA } {1.50  113.0  -45.0}}    \
                   C112PA {+ {C111PA C110PA   C19PA } {1.50  112.0 -165.0}}    \
                   C114PA {+ {C113PA C112PA   C111PA} {1.50  109.0  178.0}}    \
                   C115PA {+ {C116PA C114PA   C113PA} {1.50   30.0 -116.0}}    \
                     }                                                         \

               print {C12PA C13PA C14PA C15PA C16PA C17PA C18PA C19PA C110PA   \
                      C111PA C112PA C113PA C114PA C115PA C116PA                \
                      N31 P31 C2 C31 C32 O32 O31 C3 O21 C1 O11 C11 C21         \
                      C12OL C13OL C14OL C15OL C16OL C17OL C18OL C19OL C110OL   \
                      C111OL C112OL C113OL C114OL C115OL C116OL C117OL C118OL} \
             }
     ...
     dict set backmap                                                          \
         SPO { name PS                                                         \
               build {N31 {: BPSN} C33 {: BPSO} P31 {: BFO}                    \
                      ...
                      C118OL {: BCT2}                                          \
                                                                               \
                      C31 {+ {C33 P31  C2} {2.65   30.0    155.0}}             \
                      O32 {+ {P31 C31 C33} {1.61   25.0    -12.0}}             \
                      C32 {+ {N31 C33 C31} {1.52   35.0     35.0}}             \
                      O31 {+ {P31 O32 C31} {1.61  109.0    180.0}}             \
                      O36 {+ {C33 C32 N31} {1.43  120.0    180.0}}             \
                      O35 {+ {C33 C32 N31} {1.43  120.0     -5.0}}             \
                      O34 {+ {P31 O32 O31} {1.61  109.0   -115.0}}             \
                      O33 {+ {P31 O32 O31} {1.61  108.0    119.0}}             \
                       C3 {+ {C2  O31 P31} {1.50   32.0     88.0}}             \
                      O21 {+ {C21 C2   C3} {1.43   35.0    -77.0}}             \
                       C1 {+ {C2  C3  O21} {1.50  115.0   -125.0}}             \
                      O11 {+ {C1  C2   C3} {1.43  115.0     60.0}}             \
                    C12OL {+ {C21 O21  C2} {1.50  110.0   -180.0}}             \
                    C13OL {+ {C12OL   C21      O21  } {1.50  109.0   95.0}}    \
                    C15OL {+ {C14OL   C13OL    C12OL} {1.50  117.0   84.0}}    \
                    C16OL {+ {C15OL   C14OL    C13OL} {1.50  115.0  -35.0}}    \
                    C18OL {+ {C17OL   C16OL    C15OL} {1.50  120.0 -145.0}}    \
                    C19OL {+ {C18OL   C17OL    C16OL} {1.50  110.0  -62.0}}    \
                   C111OL {+ {C110OL  C19OL    C18OL} {1.50  130.0   -0.0}}    \
                   C112OL {+ {C113OL  C111OL  C110OL} {1.50   35.0  -35.0}}    \
                   C114OL {+ {C113OL  C112OL  C111OL} {1.50  115.0   70.0}}    \
                   C115OL {+ {C116OL  C114OL  C113OL} {1.50   30.0 -125.0}}    \
                   C117OL {+ {C118OL  C116OL  C115OL} {1.50   35.0  125.0}}    \
                    C12PA {+ {C11   O11 C1 } {1.50  109.0  -170.0}}            \
                    C13PA {+ {C12PA C11 O11} {1.50  115.0  -180.0}}            \
                    C15PA {+ {C14PA   C13PA   C12PA } {1.50  120.0   55.0}}    \
                    C16PA {+ {C15PA   C14PA   C13PA } {1.50  115.0  150.0}}    \
                    C18PA {+ {C17PA   C16PA   C15PA } {1.50  115.0 -175.0}}    \
                    C19PA {+ {C18PA   C17PA   C16PA } {1.50  115.0 -175.0}}    \
                   C111PA {+ {C110PA  C19PA   C18PA } {1.50  105.0  180.0}}    \
                   C112PA {+ {C111PA C110PA   C19PA } {1.50  115.0   85.0}}    \
                   C114PA {+ {C113PA C112PA   C111PA} {1.50  110.0 -100.0}}    \
                   C115PA {+ {C116PA C114PA   C113PA} {1.50   30.0  -20.0}}    \
                     }                                                         \

               print {C12PA C13PA C14PA C15PA C16PA C17PA C18PA C19PA C110PA   \
                      C111PA C112PA C113PA C114PA C115PA C116PA N31 C33 P31 C2 \
                      C31 C32 O32 O31 O36 O35 O34 O33 C3 O21 C1 O11 C11 C21    \
                      C12OL C13OL C14OL C15OL C16OL C17OL C18OL C19OL C110OL   \
                      C111OL C112OL C113OL C114OL C115OL C116OL C117OL C118OL} \
             }
     ...
     dict set backmap                                                          \
         GPO { name PGR                                                        \
               build {O36 {: BPG} O35 {: BPO} P31 {: BFO}                      \
                      ...
                      C118OL {: BCT2}                                          \
                                                                               \
                      C31 {+ {O35  P31   C2} {2.65   50.0   95.0}}             \
                      C32 {+ {O35  C31  P31} {1.43   38.0 -115.0}}             \
                      C33 {+ {O36  C32  O35} {1.43   35.0  -20.0}}             \
                      O32 {+ {P31  C31  C32} {1.61   30.0 -115.0}}             \
                      O31 {+ {P31  O32  C31} {1.61  105.0  160.0}}             \
                       C3 {+ {C2   O31  P31} {1.50   30.0  120.0}}             \
                      O21 {+ {C21   C2   C3} {1.43   35.0  -30.0}}             \
                       C1 {+ {C2    C3  O21} {1.50  115.0 -120.0}}             \
                      O11 {+ {C1    C2   C3} {1.43  110.0  150.0}}             \
                    C12OL {+ {C21  O21   C2} {1.50  115.0  160.0}}             \
                    C13OL {+ {C12OL   C21        O21} {1.50 110.0  -10.0}}     \
                    C15OL {+ {C14OL   C13OL    C12OL} {1.50 115.0 -175.0}}     \
                    C16OL {+ {C15OL   C14OL    C13OL} {1.50 120.0  -65.0}}     \
                    C18OL {+ {C17OL   C16OL    C15OL} {1.50 115.0  180.0}}     \
                    C19OL {+ {C18OL   C17OL    C16OL} {1.50 115.0  -75.0}}     \
                   C111OL {+ {C110OL  C19OL    C18OL} {1.50 130.0   -2.0}}     \
                   C112OL {+ {C111OL  C110OL   C19OL} {1.50 110.0 -105.0}}     \
                   C114OL {+ {C113OL  C112OL  C111OL} {1.50 115.0  -90.0}}     \
                   C115OL {+ {C114OL  C113OL  C112OL} {1.50 110.0 -180.0}}     \
                   C117OL {+ {C116OL  C115OL  C114OL} {1.50 110.0 -175.0}}     \
                    C12PA {+ {C11   O11   C1} {1.50  109.0    -175.0}}         \
                    C13PA {+ {C12PA C11  O11} {1.50  115.0    -175.0}}         \
                    C15PA {+ {C14PA   C13PA    C12PA} {1.50 115.0 -170.0}}     \
                    C16PA {+ {C15PA   C14PA    C13PA} {1.50 115.0   65.0}}     \
                    C18PA {+ {C17PA   C16PA    C15PA} {1.50 120.0   55.0}}     \
                    C19PA {+ {C18PA   C17PA    C16PA} {1.50 125.0  -88.0}}     \
                   C111PA {+ {C110PA  C19PA    C18PA} {1.50 115.0  -60.0}}     \
                   C112PA {+ {C111PA C110PA    C19PA} {1.50 115.0 -165.0}}     \
                   C114PA {+ {C113PA C112PA   C111PA} {1.50 115.0 -160.0}}     \
                   C115PA {+ {C114PA C113PA   C112PA} {1.50 105.0 -180.0}}     \
                   }                                                           \

               print {C12PA C13PA C14PA C15PA C16PA C17PA C18PA C19PA          \
                      C110PA C111PA C112PA C113PA C114PA C115PA C116PA         \
                      O36 O35 P31 C2 C31 C32 C33 O32 O31 C3 O21 C1 O11         \
                      C11 C21 C12OL C13OL C14OL C15OL C16OL C17OL C18OL        \
                      C19OL C110OL C111OL C112OL C113OL C114OL C115OL          \
                      C116OL C117OL C118OL}                                    \
             }
     dict set backmap                                                          \
          KK { name CHL                                                        \
               build {O1 {: sH1} C3 {: sO1} C1 {: sC1}                         \
                      ...
                      C22 {: sC22} C25 {: sC25}                                \
                                                                               \
                      C2  {+ {C3  C1   O1}  {1.50  35.0   15.0}}               \
                      C4  {+ {C3  C2   C1}  {1.50 109.5   60.0}}               \
                      C5  {+ {C6  C4   C3}  {1.50  35.5   80.0}}               \
                      C7  {+ {C6  C5   C4}  {1.50 120.0 -180.0}}               \
                      C8  {+ {C7  C6   C5}  {1.50 109.5   15.0}}               \
                      C9  {+ {C8  C7   C6 } {1.50 109.5  -45.0}}               \
                      C10 {+ {C1  C19  C5}  {1.50  35.0  -35.0}}               \
                      C11 {+ {C12 C9   C8}  {1.50  35.0 -130.0}}               \
                      C13 {+ {C12 C18  C11} {1.50  35.0 -130.0}}               \
                      C14 {+ {C15 C13  C12} {1.50  35.0  -15.0}}               \
                      C16 {+ {C15 C14  C13} {1.50 101.5  -25.0}}               \
                      C17 {+ {C16 C13  C18} {1.50  36.0 -120.0}}               \
                      C20 {+ {C22 C17  C16} {1.50  35.0 -130.0}}               \
                      C21 {+ {C20 C22  C17} {1.50 110.0 -125.0}}               \
                      C23 {+ {C22 C20  C17} {1.50 110.0 -180.0}}               \
                      C24 {+ {C23 C22  C20} {1.50 110.0  170.0}}               \
                      C26 {+ {C25 C24  C23} {1.50 109.5  170.0}}               \
                      C27 {+ {C25 C24  C23} {1.50 115.5  -70.0}}               \
                     }                                                         \

               print {O1 C3 C2 C4 C5 C6 C7 C8 C9 C10 C11 C13 C14               \
                      C15 C16 C17 C18 C20 C12 C19 C1 C21 C22 C23               \
                      C24 C25 C26 C27}                                         \
             }
         ...
         CZP { name SPM                                                        \
               build {N31 {: BCO} P31 {: BFO} C2 {: BGL}                       \
                      ...
                      C113PA {: BC24} C116PA {: BCT2}                          \
                                                                               \
                      C31 {+ {N31 P31  C2} {2.65   35.0     35.0}}             \
                      C32 {+ {C31 N31 P31} {1.50   31.0    153.0}}             \
                      O32 {+ {C31 P31 C32} {1.43   30.0    -20.0}}             \
                      O31 {+ {P31 O32 C31} {1.61  102.0    -35.0}}             \
                       C3 {+ {C2  O31 P31} {1.50   30.0    115.0}}             \
                      C11 {+ {N11  C2  C3} {1.52  125.0     55.0}}             \
                       C1 {+ {C2   C3 O31} {1.43  109.0    -40.0}}             \
                    C12PA {+ {C11 N11  C2} {1.50  115.0   -165.0}}             \
                    C13PA {+ {C12PA   C11      N11} {1.50   105.0 -120.0}}     \
                    C15PA {+ {C14PA   C13PA    C12PA} {1.50 120.0  170.0}}     \
                    C16PA {+ {C15PA   C14PA    C13PA} {1.50 120.0  160.0}}     \
                    C18PA {+ {C17PA   C16PA    C15PA} {1.50 115.0 -175.0}}     \
                    C19PA {+ {C18PA   C17PA    C16PA} {1.50 115.0   62.0}}     \
                   C111PA {+ {C110PA  C19PA    C18PA} {1.50 109.0  -80.0}}     \
                   C112PA {+ {C111PA  C110PA   C19PA} {1.50 102.0 -160.0}}     \
                   C114PA {+ {C113PA  C112PA  C111PA} {1.50 112.0 -180.0}}     \
                   C115PA {+ {C114PA  C113PA  C112PA} {1.50 109.0  180.0}}     \
                    C12SA {+ {C1  O22  C2} {1.50  105.0    122.0}}             \
                    C14SA {+ {C13SA   C12SA    C1   } {1.50 125.0 -180.0}}     \
                    C15SA {+ {C14SA   C13SA    C12SA} {1.50 122.0  -30.0}}     \
                    C17SA {+ {C16SA   C15SA    C14SA} {1.50 113.0  179.0}}     \
                    C18SA {+ {C19SA   C17SA    C16SA} {1.50  30.0  -40.0}}     \
                   C110SA {+ {C19SA   C18SA    C17SA} {1.50 117.0 -173.0}}     \
                   C111SA {+ {C112SA  C110SA   C19SA} {1.50  33.0   -3.5}}     \
                   C113SA {+ {C112SA  C111SA  C110SA} {1.50 116.0 -150.0}}     \
                   C114SA {+ {C115SA  C113SA  C112SA} {1.50  33.0   10.0}}     \
                     }                                                         \

               print {C12PA C13PA C14PA C15PA C16PA C17PA C18PA C19PA          \
                      C110PA C111PA C112PA C113PA C114PA C115PA C116PA         \
                      N31 P31 C2 C31 O32 C32 O31 C3 N11 C11 C1 O22 H22 O12     \
                      C12SA C13SA C14SA C15SA C16SA C17SA C18SA C19SA          \
                      C110SA C111SA C112SA C113SA C114SA C115SA}               \
             }
     ...
     dict set backmap                                                          \
         CZS { name SSM                                                        \
               build {N31 {: BCO} P31 {: BFO} C2 {: BGL}                       \
                      ...
                      C118ST {: BCT2}                                          \
                                                                               \
                      C31 {+ {N31 P31  C2} {2.65   35.0    135.0}}             \
                      C32 {+ {C31 N31 P31} {1.50   33.0    -94.0}}             \
                      O32 {+ {C31 P31 C32} {1.43   30.0   -100.0}}             \
                      O31 {+ {P31 O32 C31} {1.61  105.0     75.0}}             \
                       C3 {+ {C2  O31 P31} {1.50   32.0    -13.0}}             \
                      C11 {+ {N11  C2  C3} {1.50  124.0     70.0}}             \
                       C1 {+ {C2   C3 O31} {1.43  111.0    -65.0}}             \
                    C12ST {+ {C11 N11  C2} {1.50  120.0   -180.0}}             \
                    C14ST {+ {C13ST   C12ST    C11  } {1.50 110.0  -178.0}}    \
                    C15ST {+ {C14ST   C13ST    C12ST} {1.50 115.0   160.0}}    \
                    C17ST {+ {C16ST   C15ST    C14ST} {1.50 110.0  -170.0}}    \
                    C18ST {+ {C19ST   C17ST    C16ST} {1.50  30.0   160.0}}    \
                   C110ST {+ {C19ST   C18ST    C17ST} {1.50 113.0  -145.0}}    \
                   C111ST {+ {C112ST  C110ST   C19ST} {1.50  38.0    25.0}}    \
                   C113ST {+ {C112ST  C111ST  C110ST} {1.50 105.0  -160.0}}    \
                   C114ST {+ {C113ST  C112ST  C111ST} {1.50 114.0    72.0}}    \
                   C116ST {+ {C115ST  C114ST  C113ST} {1.50 121.0    55.0}}    \
                   C117ST {+ {C116ST  C115ST  C114ST} {1.50 114.0    65.0}}    \
                    C12SA {+ {C1  C2   C3} {1.50  113.0    180.0}}             \
                    C14SA {+ {C13SA   C12SA    C1   } {1.50 118.0   180.0}}    \
                    C15SA {+ {C14SA   C13SA    C12SA} {1.50 111.0  -110.0}}    \
                    C17SA {+ {C16SA   C15SA    C14SA} {1.50 123.0   -84.0}}    \
                    C18SA {+ {C19SA   C17SA    C16SA} {1.50  33.0  -132.0}}    \
                   C110SA {+ {C19SA   C18SA    C17SA} {1.50 109.0  -177.0}}    \
                   C111SA {+ {C112SA  C110SA   C19SA} {1.50  33.0    36.0}}    \
                   C113SA {+ {C112SA  C111SA  C110SA} {1.50 120.0  -176.0}}    \
                   C114SA {+ {C113SA  C112SA  C111SA} {1.50 111.0    74.0}}    \
                   C116SA {+ {C115SA  C114SA  C113SA} {1.50 113.0   -82.0}}    \
                     }                                                         \

               print {C12ST C13ST C14ST C15ST C16ST C17ST C18ST C19ST C110ST   \
                      C111ST C112ST C113ST C114ST C115ST C116ST C117ST C118ST  \
                      N31 P31 C2 C31 O32 C32 O31 C3 N11 C11 C1 O22 H22 O12     \
                      C12SA C13SA C14SA C15SA C16SA C17SA C18SA C19SA C110SA   \
                      C111SA C112SA C113SA C114SA C115SA C116SA}               \
             }

     # CERAMIDE --- ADDED to AA Petite SIRAH
     # CERAMIDE backmapping needs the lipid flag and the AAparams folder (inside the SIRAH folder starting from Ambertools26 and later)
     # For backmapping using other versions of Ambertools customdir flag needs to be used
     dict set backmap                                                          \
         HZS { name CER                                                        \
              build {HO1 {: BPG1} O1 {: BOG1} C2S {: BGL}                      \
                     NF {: LGN} O3 {: BOG2} HO3 {: BPG2}                       \
                     OF {: LGO}                                                \
                     C5S {: BC11} C8S {: BC12}                                 \
                     C11S {: BC13} C14S {: BC14}                               \
                     C17S {: BCT1}  C3F {: BC21}                               \
                     ...
                     C18F {: BCT2}                                             \
                                                                               \
                     C1S {+ {O1   C2S  HO1 } {1.40   35.0    125.0}}           \
                     C3S {+ {C2S  O3   HO3 } {1.50   30.0   -175.0}}           \
                     C4S {+ {C3S  C2S  HO3 } {1.50  105.0   -125.0}}           \
                     C1F {+ {OF   NF   C2S } {1.40   30.0    175.0}}           \
                     C2F {+ {C3F  C1F  NF  } {1.50   30.0    -80.0}}           \
                     C4F {+ {C3F  C2F  C1F } {1.50  113.0    -57.0}}           \
                     C5F {+ {C6F  C4F  C3F } {1.50   34.0    -11.0}}           \
                     C7F {+ {C6F  C5F  C4F } {1.50  107.0    173.0}}           \
                     C8F {+ {C7F  C6F  C5F } {1.50  120.0     75.0}}           \
                    C10F {+ {C9F  C8F  C7F } {1.50  115.0     44.0}}           \
                    C11F {+ {C12F C10F C9F } {1.50   32.0   -109.0}}           \
                    C13F {+ {C12F C11F C10F} {1.50  112.0    180.0}}           \
                    C14F {+ {C15F C13F C12F} {1.50   34.0    -38.0}}           \
                    C16F {+ {C15F C14F C13F} {1.50  112.0    178.0}}           \
                    C17F {+ {C18F C16F C15F} {1.50   30.0    106.0}}           \
                     C6S {+ {C5S  C4S  C3S } {1.50  125.0    180.0}}           \
                     C7S {+ {C6S  C5S  C4S } {1.50  115.0   -120.0}}           \
                     C9S {+ {C8S  C7S  C6S } {1.50  120.0    171.0}}           \
                    C10S {+ {C11S C9S  C8S } {1.50   35.0     35.0}}           \
                    C12S {+ {C11S C10S C9S } {1.50  119.0     88.0}}           \
                    C13S {+ {C14S C12S C11S} {1.50   35.0    106.0}}           \
                    C15S {+ {C14S C13S C12S} {1.50  117.0   -175.0}}           \
                    C16S {+ {C17S C15S C14S} {1.50   32.0    -12.0}}           \
                    C18S {+ {C17S C16S C15S} {1.50  116.0     56.0}}           \
                      }                                                        \

              print {O1 HO1 C1S NF C2S C3S O3 HO3 C4S C5S C6S C7S C8S C9S C10S \
                     C11S C12S C13S C14S C15S C16S C17S C18S C1F OF C2F C3F    \
                     C4F C5F C6F C7F C8F C9F C10F C11F C12F C13F C14F C15F     \
                     C16F C17F C18F                                            \
                    }                                                          \
              }
   ...
   #NucleosideX  --- ADDED to AA Petite SIRAH
       dict set backmap                                          \
         CMX { name CMP                                          \
              build {P {: PX}  C5' {: C5X}                       \
                     C1' {: C1X} C2 {: C2A} N1 {: N1A}           \
                     N6 {: N6A}                                  \
                                                                 \
                     N3  {+ {C2  N1  N6  } {1.40 120.0    0.0}}  \
                     C4  {+ {N3  C2  N1  } {1.40 120.0    0.0}}  \
                     ...
                     C6  {+ {N1  C2  N3  } {1.40 120.0    0.0}}  \
                     N7  {+ {C5  C4  N3  } {1.40 109.0  180.0}}  \
                     C8  {+ {N7  C5  C4  } {1.40 109.0   0.40}}  \
                     N9  {+ {C4  C5  N7  } {1.40 109.0  -0.35}}  \
                                                                 \
                     O4' {+ {C1' N9  C5' } {1.40 110.0   25.0}}  \
                     C2' {+ {C1' N9  O4' } {1.50 110.0 -115.0}}  \
                     C4' {+ {C2' C1' C5' } {2.40  66.0   10.0}}  \
                     C3' {+ {C4' O4' C5' } {1.50 105.0 -120.0}}  \
                     O2' {+ {C2' C1' N9  } {1.50 110.0 -120.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 110.0 -120.0}}  \
                     O5' {+ {P   C5' C4' } {1.50  35.0 -125.0}}  \
                     O2P {+ {P   O5' C5' } {1.50 109.0 -175.0}}  \
                     O1P {+ {P   O3' O5' } {1.50 109.0 -120.0}}  \
                     }                                           \

              print {P O1P O2P O5' C5' C4' C3' O3' C2' O2' C1'   \
       ...
       dict set backmap                                          \
         AMX { name AMP                                          \
              build {P {: PX}  C5' {: C5X}                       \
                     ...
                     N9  {+ {C4  C5  N7  } {1.40 109.0  -0.35}}  \
                                                                 \
                     O4' {+ {C1' N9  C5' } {1.40 110.0   20.0}}  \
                     C2' {+ {C1' N9  O4' } {1.50 110.0 -115.0}}  \
                     C4' {+ {C2' C1' C5' } {2.40  66.0   13.0}}  \
                     C3' {+ {C4' O4' C5' } {1.50 105.0 -120.0}}  \
                     O2' {+ {C2' C1' N9  } {1.50 110.0  -98.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 110.0 -120.0}}  \
                     O5' {+ {P   C5' C4' } {1.50  35.0   0.14}}  \
                     OP2 {+ {P   O5' C5' } {1.50 109.0  -60.0}}  \
                     OP1 {+ {P   OP2 O5' } {1.50 109.0 -120.0}}  \
                     OP3 {+ {P   OP2 O5' } {1.50 109.0  120.0}}  \
                     }                                           \

              print {OP3 P OP1 OP2 O5' C5' C4' O4' C3' O3' C2'   \
       ...
       dict set backmap                                          \
         ADX { name ADP                                          \
              build {PB {: PXB} PA {: PXA} C5' {: C5X}           \
                     ...
                     O2' {+ {C2' C1' N9  } {1.50 110.0  -98.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 110.0 -120.0}}  \
                     O5' {+ {PA  C5' C4' } {1.50  35.0    0.0}}  \
                     O2A {+ {PA  O5' C5' } {1.50 109.0  -60.0}}  \
                     O1A {+ {PA  O2A O5' } {1.50 109.0 -120.0}}  \
                     O3A {+ {PB  PA  O5' } {1.50  35.0    0.0}}  \
                     O3B {+ {PB  O3A PA  } {1.50 109.0  -60.0}}  \
                     O2B {+ {PB  O3B O3A } {1.50 109.0  120.0}}  \
                     O1B {+ {PB  O3B O3A } {1.50 109.0 -120.0}}  \
                     }                                           \

              print {PB O1B O2B O3B PA O1A O2A O3A O5' C5' C4'   \
       ...
       dict set backmap                                          \
         ATX { name ATP                                          \
              build {PG {: PXG} PB {: PXB} PA {: PXA}            \
                     C5' {: C5X} C1' {: C1X} C2 {: C2A}          \
                     N1 {: N1A} N6 {: N6A}                       \
                                                                 \
                     N3  {+ {C2  N1  N6  } {1.40 120.0    0.0}}  \
                     C4  {+ {N3  C2  N1  } {1.40 120.0    0.0}}  \
                     ...
                     N9  {+ {C4  C5  N7  } {1.40 109.0  -0.35}}  \
                                                                 \
                     O4' {+ {C1' N9  C4  } {1.40 110.0 -155.0}}  \
                     C2' {+ {C1' N9  O4' } {1.50 110.0 -115.0}}  \
                     C4' {+ {O4' C5' C1' } {1.40  35.0   30.0}}  \
                     C3' {+ {C4' O4' C5' } {1.50 105.0 -120.0}}  \
                     O2' {+ {C2' C1' N9  } {1.50 110.0  -98.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 110.0 -120.0}}  \
                     O5' {+ {PA  C5' C4' } {1.50  35.0    0.0}}  \
                     O2A {+ {PA  O5' C5' } {1.50 109.0  -60.0}}  \
                     O1A {+ {PA  O2A O5' } {1.50 109.0 -120.0}}  \
                     O3A {+ {PB  PA  O5' } {1.50  35.0   -0.1}}  \
                     O1B {+ {PB  O3A PA  } {1.50 109.0   60.0}}  \
                     O2B {+ {PB  O3A PA  } {1.50 109.0  -60.0}}  \
                     O3B {+ {PB  PG  O3A } {1.50  35.0    0.0}}  \
                     O1G {+ {PG  O3B PB  } {1.50 109.0   60.0}}  \
                     O2G {+ {PG  O3B PB  } {1.50 109.0 -180.0}}  \
                     O3G {+ {PG  O1G O3B } {1.50 109.0  120.0}}  \
                     }                                           \

              print {PG O1G O2G O3G PB O1B O2B O3B PA O1A O2A    \
                     O3A O5' C5' C4' O4' C3' O3' C2' O2' C1' N9  \
       ...
       dict set backmap                                          \
         GMX { name PCG                                          \
              build {PA {: PX}  C5' {: C5X}                      \
                     ...
                     O2' {+ {C2' C1' N9  } {1.50 110.0 -120.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 109.0 -120.0}}  \
                     O5' {+ {PA  C5' C4' } {1.50  30.0 -125.0}}  \
                     O1A {+ {PA  O5' O3' } {1.50 109.0 -120.0}}  \
                     O2A {+ {PA  O1A O3' } {1.50 109.0 -120.0}}  \
                     }                                           \

              print {PA O1A O2A O5' C5' C4' O4' C3' O3' C2' O2'  \
       ...
       dict set backmap                                          \
         GDX { name GDP                                          \
              build {PB {: PXB} PA {: PXA}  C5' {: C5X}          \
                     ...
                     C4' {+ {C2' C1' C5' } {2.40  66.0   16.0}}  \
                     C3' {+ {C4' O4' C5' } {1.50 109.0 -120.0}}  \
                     O2' {+ {C2' C1' N9  } {1.50 110.0  -86.0}}  \
                     O3' {+ {C3' C4' C2' } {1.40 109.0 -120.0}}  \
                     O5' {+ {PA  C5' C4' } {1.50  30.0    0.0}}  \
                     O2A {+ {PA  O5' C5' } {1.50 109.0  -65.0}}  \
                     O1A {+ {PA  O2A O5' } {1.50 109.0 -120.0}}  \
                     O3A {+ {PB  PA  O5' } {1.50  22.0   25.0}}  \
                     O2B {+ {PB  O3A PA  } {1.50 109.0 -160.0}}  \
                     O1B {+ {PB  O2B O3A } {1.50 109.0 -120.0}}  \
                     O3B {+ {PB  O1B O3A } {1.50 109.0 -120.0}}  \
                     }                                           \

              print {PB O1B O2B O3B O3A PA O1A O2A O5' C5' C4'   \
                     O4' C3' O3' C2' O2' C1' N9 C8 N7 C5 C6 O6   \
                     N1 C2 N2 N3 C4                              \
                    }                                            \
              }
       ...
       dict set backmap                                          \
         GTX { name GTP                                          \
              build {PG {: PXG} PB {: PXB} PA {: PXA}            \
                     ...
                     O1A {+ {PA  O2A O5' } {1.50 109.0 -120.0}}  \
                     O3A {+ {PB  PA  O5' } {1.50  22.0   25.0}}  \
                     O2B {+ {PB  O3A PA  } {1.50 109.0  -75.0}}  \
                     O1B {+ {PB  O2B O3A } {1.50 109.0 -120.0}}  \
                     O3B {+ {PB  PG  O3A } {1.50  22.0  -25.0}}  \
                     O1G {+ {PG  O3B PB  } {1.50 109.0  -40.0}}  \
                     O2G {+ {PG  O3B O1G } {1.50 109.0 -120.0}}  \
                     O3G {+ {PG  O1G O3B } {1.50 109.0 -120.0}}  \
                     }                                           \

              print {PG O1G O2G O3G O3B PB O1B O2B O3A PA O1A    \
                     O2A O5' C5' C4' O4' C3' O3' C2' O2' C1' N9  \
...
proc sirah_backmap {args} {
   # Read arguments --------------------------------------------------------------------------------------------
     ...
     array set opts [ getopts $args switch { now nomin lipid cuda gbsa noload help } option { mol first last each frames outname mpi maxcyc ncyc cutoff customdir} ]
     ...
     if {![info exists opts(lipid)]}       { set opts(lipid) 0 }
     ...
     if {![info exists opts(maxcyc)]}      { set opts(maxcyc) 150 ; if { $opts(lipid) != 0 } {set opts(maxcyc) 150} }

     if {![info exists opts(ncyc)]}        { set opts(ncyc)   100 ; if { $opts(lipid) != 0 } {set opts(ncyc)   100} }
     
     if {![info exists opts(cutoff)]}      { set opts(cutoff) 9 }
     ...
     # customdir flag.
     # It looks for leaprc.AApetitesirah in the given directory. If you are using a different leaprc file, change its name in this loop
     # or change its name to leaprc.AApetitesirah in your directory.
     if {[info exists opts(customdir)]} {
         if {[file exists $opts(customdir)] && [file isdirectory $opts(customdir)]} {
             #Change the "leaprc.petitesirah" name on the next line.
             set leaprc_file [file join $opts(customdir) "leaprc.AApetitesirah"]
             if {[file exists $leaprc_file]} {
                  set custom_path $opts(customdir)
                  lappend forcefield(cmd)    $leaprc_file
                  puts "Using custom directory: $custom_path"
              } else {
                  puts stderr "Error! File 'leaprc.AApetitesirah' not found in: $opts(customdir)"
                  return
              }
         } else {
             puts stderr "Error! Custom directory does not exist or is not a directory: $opts(customdir)"
             return
         }
     } else {
         set custom_path "" ; set opts(customdir) 0
     }

   #------------------------------------------------------------------------------------------------------------

     # Remove the option to use the flags nomin and lipid together
     # This avoids poor backmapped postions of the lipids
     if { $opts(lipid) != 0 && $opts(nomin) != 0 } { puts stderr "Backmapping of lipids is not available with the nomin option."      ; return }
     ...
     if {! $opts(nomin) } {
      ...
      # Check required packages
        ...
        global env
        if {![info exists  env(AMBERHOME)]}                                                             { puts stderr "AMBERTOOLS is not available, check \$AMBERHOME path" ; return }
      ...
      # GAFF2
        if     { [file exists $env(AMBERHOME)/dat/leap/cmd/leaprc.gaff2]       } { lappend forcefield(cmd)       leaprc.gaff2 }\
        elseif { [file exists $env(AMBERHOME)/dat/leap/cmd/oldff/leaprc.gaff2]   } { lappend forcefield(cmd) oldff/leaprc.gaff2 }\
        else   {  puts stderr "Can't find GAFF2" ; return }

      # Petite SIRAH
      # The leaprc.petitesirah and the parm folder should be available in AmberTools26 and subsequent releases.
        if { $opts(customdir) == 0 } {
              if     { [file exists $env(AMBERHOME)/dat/SIRAH/AAparams/leaprc.AApetitesirah] } { lappend forcefield(cmd)    leaprc.AApetitesirah; set custom_path "$env(AMBERHOME)/dat/SIRAH/AAparams/" }\
              else   {  puts stderr "\nCan't find AA Petite SIRAH. Make sure you are using AMBERTOOLS26 (or higher), \nor set the PATH using the customdir flag." ; set custom_path ""  }
        }
   ...
   # Set new residue index
     ...
     #Remove the dictionary keys for the lipids if the lipid flag is not used.
     if { $opts(lipid) == 0 } {
     # Safe dict remove - only removes if key exists
        foreach key {CPO EPO SPO CMM GPO KK CZP CZS HZS} {
          if {[dict exists $backmap $key]} {
              set backmap [dict remove $backmap $key]
          }
        }
    
      # Create auxiliary dictionary with all needed entries
        set auxdic [dict create \
          CPO " nomap *" \
          EPO " nomap *" \
          SPO " nomap *" \
          CMM " nomap *" \
      ...
      # Merge the dictionaries
        set backmap [dict merge $backmap $auxdic]
     }
   ...
   # Save trajectory to backmap PDB
     ...
     # Loop to edit and organize lipid tail names to be recognized by Lipid21
     # This open the PDB and edit it inside vmd
     if { $opts(lipid) != 0 } {
        set f [open "backmap_geom.pdb" r+]
        set data [read $f]

        # Define a mapping table of patterns to replacements
        array set specific_replacements {
        # POPC
        {C12PA  PC}  {  C12  PA} {C13PA  PC}  {  C13  PA} {C14PA  PC}  {  C14  PA} {C15PA  PC}  {  C15  PA} {C16PA  PC}  {  C16  PA} {C17PA  PC}  {  C17  PA} {C18PA  PC}  {  C18  PA} {C19PA  PC}  {  C19  PA} \
        {C110PA  PC} { C110  PA} {C111PA  PC} { C111  PA} {C112PA  PC} { C112  PA} {C113PA  PC} { C113  PA} {C114PA  PC} { C114  PA} {C115PA  PC} { C115  PA} {C116PA  PC} { C116  PA} \
        {C12OL  PC}  {  C12  OL} {C13OL  PC}  {  C13  OL} {C14OL  PC}  {  C14  OL} {C15OL  PC}  {  C15  OL} {C16OL  PC}  {  C16  OL} {C17OL  PC}  {  C17  OL} {C18OL  PC}  {  C18  OL} {C19OL  PC} {  C19  OL}  \
        {C110OL  PC} { C110  OL} {C111OL  PC} { C111  OL} {C112OL  PC} { C112  OL} {C113OL  PC} { C113  OL} {C114OL  PC} { C114  OL} {C115OL  PC} { C115  OL} {C116OL  PC} { C116  OL} {C117OL  PC} { C117  OL} {C118OL  PC} { C118  OL} \
        # POPE
        {C12PA  PE}  {  C12  PA} {C13PA  PE}  {  C13  PA} {C14PA  PE}  {  C14  PA} {C15PA  PE}  {  C15  PA} {C16PA  PE}  {  C16  PA} {C17PA  PE}  {  C17  PA} {C18PA  PE}  {  C18  PA} {C19PA  PE}  {  C19  PA} \
        {C110PA  PE} { C110  PA} {C111PA  PE} { C111  PA} {C112PA  PE} { C112  PA} {C113PA  PE} { C113  PA} {C114PA  PE} { C114  PA} {C115PA  PE} { C115  PA} {C116PA  PE} { C116  PA} \
        {C12OL  PE}  {  C12  OL} {C13OL  PE}  {  C13  OL} {C14OL  PE}  {  C14  OL} {C15OL  PE}  {  C15  OL} {C16OL  PE}  {  C16  OL} {C17OL  PE}  {  C17  OL} {C18OL  PE}  {  C18  OL} {C19OL  PE}  {  C19  OL} \
        {C110OL  PE} { C110  OL} {C111OL  PE} { C111  OL} {C112OL  PE} { C112  OL} {C113OL  PE} { C113  OL} {C114OL  PE} { C114  OL} {C115OL  PE} { C115  OL} {C116OL  PE} { C116  OL} {C117OL  PE} { C117  OL} {C118OL  PE} { C118  OL} \
        # POPS
        {C12PA  PS}  {  C12  PA} {C13PA  PS}  {  C13  PA} {C14PA  PS}  {  C14  PA} {C15PA  PS}  {  C15  PA} {C16PA  PS}  {  C16  PA} {C17PA  PS}  {  C17  PA} {C18PA  PS}  {  C18  PA} {C19PA  PS}  {  C19  PA} \
        {C110PA  PS} { C110  PA} {C111PA  PS} { C111  PA} {C112PA  PS} { C112  PA} {C113PA  PS} { C113  PA} {C114PA  PS} { C114  PA} {C115PA  PS} { C115  PA} {C116PA  PS} { C116  PA} \
        {C12OL  PS}  {  C12  OL} {C13OL  PS}  {  C13  OL} {C14OL  PS}  {  C14  OL} {C15OL  PS}  {  C15  OL} {C16OL  PS}  {  C16  OL} {C17OL  PS}  {  C17  OL} {C18OL  PS}  {  C18  OL} {C19OL  PS}  {  C19  OL} \
        {C110OL  PS} { C110  OL} {C111OL  PS} { C111  OL} {C112OL  PS} { C112  OL} {C113OL  PS} { C113  OL} {C114OL  PS} { C114  OL} {C115OL  PS} { C115  OL} {C116OL  PS} { C116  OL} {C117OL  PS} { C117  OL} {C118OL  PS} { C118  OL} \
        # POPG
        {C12PA PGR}  {  C12  PA} {C13PA PGR}  {  C13  PA} {C14PA PGR}  {  C14  PA} {C15PA PGR}  {  C15  PA} {C16PA PGR}  {  C16  PA} {C17PA PGR}  {  C17  PA} {C18PA PGR}  {  C18  PA} {C19PA PGR}  {  C19  PA} \
        {C110PA PGR} { C110  PA} {C111PA PGR} { C111  PA} {C112PA PGR} { C112  PA} {C113PA PGR} { C113  PA} {C114PA PGR} { C114  PA} {C115PA PGR} { C115  PA} {C116PA PGR} { C116  PA} \
        {C12OL PGR}  {  C12  OL} {C13OL PGR}  {  C13  OL} {C14OL PGR}  {  C14  OL} {C15OL PGR}  {  C15  OL} {C16OL PGR}  {  C16  OL} {C17OL PGR}  {  C17  OL} {C18OL PGR}  {  C18  OL} {C19OL PGR}  {  C19  OL} \
        {C110OL PGR} { C110  OL} {C111OL PGR} { C111  OL} {C112OL PGR} { C112  OL} {C113OL PGR} { C113  OL} {C114OL PGR} { C114  OL} {C115OL PGR} { C115  OL} {C116OL PGR} { C116  OL} {C117OL PGR} { C117  OL} {C118OL PGR} { C118  OL} \
        # DMPC
        {C12MYA  PC}  {  C12  MY} {C13MYA  PC}  {  C13  MY} {C14MYA  PC}  {  C14  MY} {C15MYA  PC}  {  C15  MY} {C16MYA  PC}  {  C16  MY} {C17MYA  PC}  {  C17  MY} {C18MYA  PC}  {  C18  MY} {C19MYA  PC}  {  C19  MY} \
        {C110MYA  PC} { C110  MY} {C111MYA  PC} { C111  MY} {C112MYA  PC} { C112  MY} {C113MYA  PC} { C113  MY} {C114MYA  PC} { C114  MY} \
        {C12MYB  PC}  {  C12  MY} {C13MYB  PC}  {  C13  MY} {C14MYB  PC}  {  C14  MY} {C15MYB  PC}  {  C15  MY} {C16MYB  PC}  {  C16  MY} {C17MYB  PC}  {  C17  MY} {C18MYB  PC}  {  C18  MY} {C19MYB  PC}  {  C19  MY} \
        {C110MYB  PC} { C110  MY} {C111MYB  PC} { C111  MY} {C112MYB  PC} { C112  MY} {C113MYB  PC} { C113  MY} {C114MYB  PC} { C114  MY} \
        # SSM
        {C12ST SSM}  {  C12  ST} {C13ST SSM}  {  C13  ST} {C14ST SSM}  {  C14  ST} {C15ST SSM}  {  C15  ST} {C16ST SSM}  {  C16  ST} {C17ST SSM}  {  C17  ST} {C18ST SSM}  {  C18  ST} {C19ST SSM}  {  C19  ST} \
        {C110ST SSM} { C110  ST} {C111ST SSM} { C111  ST} {C112ST SSM} { C112  ST} {C113ST SSM} { C113  ST} {C114ST SSM} { C114  ST} {C115ST SSM} { C115  ST} {C116ST SSM} { C116  ST} {C117ST SSM} { C117  ST} {C118ST SSM} { C118  ST} \
        {C12SA SSM}  {  C12  SA} {C13SA SSM}  {  C13  SA} {C14SA SSM}  {  C14  SA} {C15SA SSM}  {  C15  SA} {C16SA SSM}  {  C16  SA} {C17SA SSM}  {  C17  SA} {C18SA SSM}  {  C18  SA} {C19SA SSM}  {  C19  SA} \
        {C110SA SSM} { C110  SA} {C111SA SSM} { C111  SA} {C112SA SSM} { C112  SA} {C113SA SSM} { C113  SA} {C114SA SSM} { C114  SA} {C115SA SSM} { C115  SA} {C116SA SSM} { C116  SA}  \
        # PSM
        {C12PA SPM}  {  C12  PA} {C13PA SPM}  {  C13  PA} {C14PA SPM}  {  C14  PA} {C15PA SPM}  {  C15  PA} {C16PA SPM}  {  C16  PA} {C17PA SPM}  {  C17  PA} {C18PA SPM}  {  C18  PA} {C19PA SPM}  {  C19  PA} \
        {C110PA SPM} { C110  PA} {C111PA SPM} { C111  PA} {C112PA SPM} { C112  PA} {C113PA SPM} { C113  PA} {C114PA SPM} { C114  PA} {C115PA SPM} { C115  PA} {C116PA SPM} { C116  PA} \
        {C12SA SPM}  {  C12  SA} {C13SA SPM}  {  C13  SA} {C14SA SPM}  {  C14  SA} {C15SA SPM}  {  C15  SA} {C16SA SPM}  {  C16  SA} {C17SA SPM}  {  C17  SA} {C18SA SPM}  {  C18  SA} {C19SA SPM}  {  C19  SA} \
        {C110SA SPM} { C110  SA} {C111SA SPM} { C111  SA} {C112SA SPM} { C112  SA} {C113SA SPM} { C113  SA} {C114SA SPM} { C114  SA} {C115SA SPM} { C115  SA} \
       }

      # Group 2: Generic replacements (lower priority)
        array set generic_replacements {
          {SSM}        {SPM}
          {PSM}        {SPM}
        }

      # Apply specific replacements first
        foreach pattern [array names specific_replacements] {
          set replacement $specific_replacements($pattern)
          regsub -all $pattern $data $replacement data
        }

      # Apply generic replacements last
        foreach pattern [array names generic_replacements] {
          set replacement $generic_replacements($pattern)
          regsub -all $pattern $data $replacement data
        }
       ...
       # Minimaze structure
         if {! $opts(nomin)} {
          ...
          # Generate AMBER topology
            #if { [catch {exec $tleap -I $custom_dir -f backmap.leap}] } { puts stderr "\nError generating AMBER topology at frame $frame, check file .backmap/leap.log"; cd .. ; return }
            if {$custom_path != ""} {
            # If the AA Petite SIRAH directory is valid, use -I flag of tleap
                if { [catch {exec $tleap -I $custom_path -f backmap.leap}] } { puts stderr "\nError generating AMBER topology at frame $frame, check file .backmap/leap.log"; cd .. ; return }
            } else {
            # If the directory is not valid, only Amber topologies
...
proc sirah_macros {} {
   # Set some selection macros
     atomselect macro sirah_membrane {resname "xP[CESA]" xMY xOL CMM CPP CPO EPO SPO GPO CZP CZS HZS KK}
